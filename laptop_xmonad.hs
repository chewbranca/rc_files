...
modMask' = mod4Mask
-- Define workspaces
myWorkspaces    = ["1:main","2:web","3:vim","4:emacs","5:music", "6:gimp", "7:misc", "8:full", "9:music"]
-- Dzen/Conky
myXmonadBar = "dzen2 -x '0' -y '0' -h '24' -w '1120' -ta 'l' -fg '#FFFFFF' -bg '#1B1D1E'"
myStatusBar = "conky -c /home/russell/.xmonad/conky_dzen | dzen2 -x '1120' -w '800' -h '24' -ta 'r' -bg '#1B1D1E' -fg '#FFFFFF' -y '0'"
myBitmapsDir = "/home/russell/.xmonad/dzen2"
--}}}
-- Main {{{
main = do
...
manageHook' = (composeAll . concat $
    ...
    where
        ...
        myVim	  = ["Gvim"]
        myEmacs	  = ["emacs","emacs24"]
        myHon	  = ["hon","heroesofnewerth","hon-x86_64"]
...
-- }}}
layoutHook'  =  onWorkspaces ["1:main","5:music"] mainLayout $ 
                onWorkspaces ["9:music"] customLayout $ 
                onWorkspaces ["6:gimp"] gimpLayout $ 
                -- onWorkspaces ["4:chat"] imLayout $
                onWorkspaces ["4:emacs"] emacsLayout $
                onWorkspaces ["8:full"] honLayout $
                customLayout2
...
mainLayout = avoidStruts $ spiral (4/7) ||| Circle ||| ThreeCol 1 (3/100) (1/2) ||| ThreeColMid 1 (3/100) (1/2) ||| Grid ||| tiled ||| Mirror tiled ||| Full ||| simpleFloat
  where
    tiled   = ResizableTall 1 (2/100) (1/2) []
...
-- honLayout = noBorders Full
honLayout = smartBorders Full

emacsLayout = smartBorders Full
...
keys' conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    -- thinkpad settings
    , ((0,                          0x1008FF2D  ), spawn "xscreensaver-command -lock")   -- F2 -- XF86ScreenSaver
    , ((0,                          0x1008FF2F  ), spawn "sudo pm-suspend")   -- F4 -- XF86Sleep
    -- , ((0,                          0x1008FF8F  ), spawn "")   -- F6 -- XF86WebCam
    -- , ((0,                          0x1008FFA9  ), spawn "")   -- F8 -- XF86TouchpadToggle
    -- , ((0,                          0x1008FF93  ), spawn "")   -- F3 -- XF86Battery
    -- , ((0,                          0x1008FFA7  ), spawn "")   -- F12 -- XF86Suspend
    -- , ((0,                          0x1008FF59  ), spawn "")   -- F7 -- XF86Display
    ...
    , ((modMask,                    xK_q        ), spawn "/usr/bin/xmonad --recompile && /user/bin/xmonad --restart")
    ]
    ++
